...
// دردشة مباشرة — لوحة المراسلة اليدوية للموظف على محادثات وصلت من أيقونة
// الدردشة في صفحة "اطلب الخدمة" العامة (LiveChatWidget.tsx). بشرية
// بالكامل عمداً — بلا أي رد آلي، انظر تعليق LiveChatThread في shared/types.ts.
function LiveChatSection() {
  ...
  function refresh() {
    api.get<LiveChatThread[]>('/chat/threads').then(setThreads);
  }
  useEffect(() => {
    refresh();
    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-5">
      <div className="mb-4">
        ...
        <p className="text-sm text-slate-400">
          {t('محادثات وصلت من أيقونة الدردشة في صفحة "اطلب الخدمة" العامة — رد بشري يدوي بالكامل، بلا ذكاء اصطناعي')}
        </p>
      </div>

      <div className="grid gap-4 lg:grid-cols-[280px_1fr]">
        <div className="space-y-2 overflow-y-auto lg:max-h-[28rem]">
        ...
        <div className="flex flex-col rounded-xl border border-slate-200">
          {!openThread ? (
            ...
            <>
              ...
              <div ref={listRef} className="max-h-80 flex-1 space-y-2 overflow-y-auto bg-slate-50 p-3">
